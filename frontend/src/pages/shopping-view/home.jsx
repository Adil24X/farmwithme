...
import HeroBanner from "@/components/homep/HeroBanner";
...
const categoriesWithIcon = [
  { id: "Vegetables", label: "Vegetables", icon: ShirtIcon },
  { id: "Fruits", label: "Fruits", icon: CloudLightning },
  { id: "Spices", label: "Spices", icon: BabyIcon },
  { id: "DryFruits", label: "Dry Fruits", icon: WatchIcon },
  { id: "Organic", label: "Organic", icon: UmbrellaIcon },
];
